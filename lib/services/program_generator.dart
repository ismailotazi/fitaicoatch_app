      ...
      return {
        t.day1: [
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=hip+thrust+proper+form+women+glutes+barbell',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=glute+bridge+proper+form+women+booty+activation',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=cable+kickback+glutes+proper+form+women',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=bulgarian+split+squat+proper+form+women+glutes+legs',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=step+ups+exercise+proper+form+women+glutes+legs',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=hip+abduction+machine+proper+form+women+glutes',
        ...
        t.day2: [
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=lat+pulldown+proper+form+women+back+exercise',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=dumbbell+row+proper+form+women+back+workout',
          ...
          },
          {
            ...
            'description': t.dumbbellRowDesc,
            'video':
                'https://www.youtube.com/results?search_query=dumbbell+shoulder+press+proper+form+women',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=dumbbell+lateral+raise+proper+form+women',
          ...
          },
          {
            ...
            'video':
                'https://www.youtube.com/results?search_query=tricep+pushdown+cable+proper+form+women',
        ...
        t.day4: [
          ...
          },
          {
            ...
            'video': 'https://www.youtube.com/watch?v=1BZM6l4g3xQ',
        ...
        t.day5: [
          {
            ...
            'video': 'https://www.youtube.com/watch?v=50kH47ZztHs',
